...
class App(customtkinter.CTk):
    ...
    def select_frame_by_name(self, name):
        ...
        if name == "diskutil":
            ...
            self.diskutil_frame_label = customtkinter.CTkLabel(self.diskutil_frame, text="Disk Utilization By Drive",
                                                                compound="center", font=customtkinter.CTkFont(size=15, weight="bold"))
            self.diskutil_frame_label.grid(row=0, column=0, padx=20, pady=20)
        ...
        if name == "diskfutil":
            ...
            self.diskfutil_frame_label = customtkinter.CTkLabel(self.diskfutil_frame, text="Disk Utilization By File Type",
                                                                compound="center", font=customtkinter.CTkFont(size=15, weight="bold"))
            self.diskfutil_frame_label.grid(row=0, column=0, padx=20, pady=20)
        ...
        if name == "large":
            ...
            self.large_frame_label = customtkinter.CTkLabel(self.large_frame, text="Files Larger than 100 MB",
                                                                compound="center", font=customtkinter.CTkFont(size=15, weight="bold"))
            self.large_frame_label.grid(row=0, column=0, padx=20, pady=20)
        ...
        if name == "infreq":
            ...
            self.infreq_frame_label = customtkinter.CTkLabel(self.infreq_frame, text="Infrequent Files",
                                                                compound="center", font=customtkinter.CTkFont(size=15, weight="bold"))
            self.infreq_frame_label.grid(row=0, column=0, padx=20, pady=20)
        ...
        if name=="settings":
            ...
            self.settings_frame_label = customtkinter.CTkLabel(self.settings_frame, text="Settings",
                                                                compound="center", font=customtkinter.CTkFont(size=15, weight="bold"))
    ...
    def home_frame_button_event(self):
        ...
        if files:
            ...
            for i in range(1,len(files)+1):
                size = os.path.getsize(files[i-1][0])
    ...
    def diskutil_frame_button_event(self):
        ...
        self.scrollable_frame = customtkinter.CTkScrollableFrame(self.diskutil_frame, label_text="Disk Utilization", height=500)
        self.scrollable_frame.grid(row=3, column=0, padx=(20, 20), pady=(20, 20), sticky="nsew")
        self.scrollable_frame.grid_columnconfigure(0, weight=2)
        self.scrollable_frame.grid_columnconfigure((1,2), weight=1)
        self.variables=[]
        ...
        for i in range(1,len(ans[0])+1):
            self.variables.append(tk.IntVar(value=0))
            switch = customtkinter.CTkSwitch(master=self.scrollable_frame, text=ans[0][i-1], variable=self.variables[i-1])
            switch.grid(row=i, column=0, padx=10, pady=20)
    ...
    def diskfutil_frame_button_event(self):
        ...
        self.scrollable_frame = customtkinter.CTkScrollableFrame(self.diskfutil_frame, label_text="Disk Utilization", height=500)
        self.scrollable_frame.grid(row=3, column=0, padx=(20, 20), pady=(20, 20), sticky="nsew")
    ...
    def large_frame_button_event(self):
        ...
        if ans:
            ...
            self.scrollable_frame = customtkinter.CTkScrollableFrame(self.large_frame, label_text="Large Files", height=500)
            self.scrollable_frame.grid(row=3, column=0, padx=(20, 20), pady=(20, 20), sticky="nsew")
            self.scrollable_frame.grid_columnconfigure((0,1), weight=1)
            # self.scrollable_frame.grid_columnconfigure((1,2), weight=1)
            self.variables=[]
    ...
    def infreq_frame_button_event(self):
        ...
        self.infreq=ans
        if ans:
            # button for deleting infrequent files
            ...
            self.scrollable_frame = customtkinter.CTkScrollableFrame(self.infreq_frame, label_text="Infrequent Files", height=500)
            self.scrollable_frame.grid(row=3, column=0, padx=(20, 20), pady=(20, 20), sticky="nsew")
            self.scrollable_frame.grid_columnconfigure(0, weight=2)
            self.scrollable_frame.grid_columnconfigure((1,2), weight=1)
            self.variables=[]
